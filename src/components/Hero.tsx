...
export default function Hero() {
  return (
    <header className="relative overflow-hidden min-h-[90vh] flex items-center">
      ...
      <nav className="absolute top-0 left-0 right-0 z-10 container mx-auto px-4 sm:px-6 py-6">
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 flex flex-col items-center text-center mt-16 sm:mt-0">
        <div className="animate-fade-in-up">
          ...
          <p className="text-lg sm:text-xl text-gray-300 mb-12 max-w-2xl mx-auto px-4">
